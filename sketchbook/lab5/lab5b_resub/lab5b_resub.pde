...
void draw() {
  ...
  pattern(350, 150, 200, 50, 10); //top middle
  pattern(550, 150, 200, 225, 25); //top right
  pattern(150, 350, 200, 50, 10); //left middle 
  pattern(150, 550, 200, 225, 25); //left bottom
  pattern(550, 350, 200, 50, 10); //right middle
  pattern(550, 550, 200, 225, 25); //right bottom
  pattern(350, 550, 200, 50, 10); //bottom middle
  pattern(width/2, height/2, 400, 191, 13); //bigger center pattern
  pattern(width/2, height/2, 200, 50, 10); //center pattern
}
