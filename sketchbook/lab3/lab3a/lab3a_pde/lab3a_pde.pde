...
void setup() {
  ...
  cloudX = -10; // initializes the variable and sets it off screen
}
...
void draw() {
  ...
  ellipse(cloudX - 40, 110, 50, 50); //medium circle
...
void mouseClicked() {
  cloudX = -10; //resets the position of the cloud to it's original value when the mouse is clicked
}
